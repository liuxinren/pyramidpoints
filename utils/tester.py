...
class ModelTester:
    ...
    def test_classification(self, model, dataset, num_votes=10):
    ...
    def test_segmentation(self, model, dataset, num_votes=10, num_saves=10):
    ...
    def test_multi_segmentation(self, model, dataset, num_votes=10, num_saves=10):
    ...
    def test_cloud_segmentation(self, model, dataset, num_votes=10):
    ...
    def test_cloud_segmentation_on_val(self, model, dataset, num_votes=10):
