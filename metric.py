...
class ConfusionMatrix:
    ...
    def print_metrics(self, log_file, labels=None):
        with open(log_file, 'a') as log:
            ...
            log.write("\n")
            log.write("IoU per class:\n")
            log.write("{}\n".format(self.get_per_class_ious()))
            ...
            log.write("mIoU (ignoring label 0):\n")
            log.write("{}\n".format(self.get_mean_iou()))

            # 4. Overall accuracy
            print("Overall accuracy")
            print(self.get_accuracy())

            log.write("Overall accuracy\n")
            log.write("{}\n\n\n".format(self.get_accuracy()))
